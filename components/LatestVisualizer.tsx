                  ...
                  {data.map(row => (
                      <div 
                        ...
                        className={`
                            ...
                            ${row.highlight ? 'bg-emerald-500/10 dark:bg-emerald-500/20' : 'hover:bg-zinc-50 dark:hover:bg-white/5'}
                        `}
                      >
                          ...
                          <div className="flex items-center gap-3">
                              <span className={`font-mono text-lg font-bold transition-all duration-300 ${row.highlight ? 'text-emerald-600 dark:text-emerald-400 scale-110' : 'text-zinc-400 dark:text-zinc-500'}`}>
                                  {row.value}
                              </span>
                              <div className={`w-1.5 h-1.5 rounded-full ${row.highlight ? 'bg-emerald-500' : 'bg-transparent'} transition-colors duration-500`}></div>
                          </div>
                      </div>
                  ))}
              </div>
               ...
               `}>
                  ...
                  <div className="flex flex-col">
                      ...
                      <div className="flex items-center gap-2 font-mono text-sm">
                          ...
                          <span className="text-emerald-600 dark:text-emerald-400 font-bold">{incomingUpdate?.value}</span>
                      </div>
                  </div>
               </div>
          </div>
